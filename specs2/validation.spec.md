...
specdown validates documents against the [depends::spec syntax](syntax.spec.md)
at parse time and rejects malformed input before any adapter is invoked.
The following errors are caught during parsing.
