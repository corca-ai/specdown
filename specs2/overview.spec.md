...
This guide walks through [explains::writing specs](syntax.spec.md),
[explains::configuring a project](config.spec.md),
and [explains::running from the command line](cli.spec.md).
