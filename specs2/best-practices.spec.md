...
These patterns apply to [explains::spec syntax](syntax.spec.md),
[explains::project configuration](config.spec.md),
and [explains::adapter development](adapter-protocol.spec.md).
